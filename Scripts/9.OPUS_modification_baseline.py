...
parser.add_argument("--s", help="echo the string you use here", default="")
parser.add_argument("--t", help="echo the string you use here", default="")
parser.add_argument("--s3", help="echo the string you use here", default="")
parser.add_argument("--t3", help="echo the string you use here", default="")
